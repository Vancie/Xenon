...
#include "Xenon/Events/ApplicationEvent.hpp"
#include "Xenon/Events/Event.hpp"
#include "Xenon/Events/KeyEvent.hpp"
#include "Xenon/Events/MouseEvent.hpp"
...
void MacOSWindow::Init(const WindowProps &props) {
  m_Data.Title = "MacOS Window";
  m_Data.Width = props.Width;
  m_Data.Height = props.Height;

  XN_CORE_INFO("Creating window {0} ({1} {2})", props.Title, props.Width,
               props.Height);
