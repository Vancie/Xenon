...
/*
 *
 * Events are currently blocking, will implement Event queue to enable
 * non-blocking events
 *
 */
...
#define EVENT_CLASS_CATAGORY(catagory)                                         \
  virtual int GetCatagoryFlags() const override { return catagory; }
...
public:
  ...
  bool Handled = false; // flag for if event has been handled
};
